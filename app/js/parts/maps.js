let firstMapContainer = document.querySelector("#map-1");
let secondMapContainer = document.querySelector("#map-2");
let thirdMapContainer = document.querySelector("#map-3");
